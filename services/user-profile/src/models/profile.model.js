...
import { PrivacyLevel } from '../types/index.js';
...
export class ProfileModel {
   ...
   */
  static async findAll(page = 1, limit = 20, options = {}) {
   ...
   */
  static async search(searchTerm, page = 1, limit = 20, options = {}) {
    const offset = (page - 1) * limit;
   ...
   */
  static applyPrivacyFilter(profile, options) {
   ...
   */
  static async updatePrivacySettings(id, settings) {
